...
class Tuple4<T1, T2, T3, T4> {
  ...
  @override
  bool operator ==(Object other) =>
      other is Tuple4 && other.item1 == item1 && other.item2 == item2 && other.item3 == item3 && other.item4 == item4;

  @override
  int get hashCode => Object.hash(item1.hashCode, item2.hashCode, item3.hashCode, item4.hashCode);
}
...
class Tuple5<T1, T2, T3, T4, T5> {
  ...
  /// Returns a tuple with the first item set to the specified value.
  Tuple5<T1, T2, T3, T4, T5> withItem1(T1 v) => Tuple5<T1, T2, T3, T4, T5>(v, item2, item3, item4, item5);

  /// Returns a tuple with the second item set to the specified value.
  Tuple5<T1, T2, T3, T4, T5> withItem2(T2 v) => Tuple5<T1, T2, T3, T4, T5>(item1, v, item3, item4, item5);

  /// Returns a tuple with the third item set to the specified value.
  Tuple5<T1, T2, T3, T4, T5> withItem3(T3 v) => Tuple5<T1, T2, T3, T4, T5>(item1, item2, v, item4, item5);

  /// Returns a tuple with the fourth item set to the specified value.
  Tuple5<T1, T2, T3, T4, T5> withItem4(T4 v) => Tuple5<T1, T2, T3, T4, T5>(item1, item2, item3, v, item5);

  /// Returns a tuple with the fifth item set to the specified value.
  Tuple5<T1, T2, T3, T4, T5> withItem5(T5 v) => Tuple5<T1, T2, T3, T4, T5>(item1, item2, item3, item4, v);
  ...
  @override
  int get hashCode => Object.hashAll([item1.hashCode, item2.hashCode, item3.hashCode, item4.hashCode, item5.hashCode]);
}
...
class Tuple6<T1, T2, T3, T4, T5, T6> {
  ...
  factory Tuple6.fromList(List items) {
    ...
    return Tuple6<T1, T2, T3, T4, T5, T6>(
        items[0] as T1, items[1] as T2, items[2] as T3, items[3] as T4, items[4] as T5, items[5] as T6);
  }
  ...
  @override
  int get hashCode =>
      Object.hashAll([item1.hashCode, item2.hashCode, item3.hashCode, item4.hashCode, item5.hashCode, item6.hashCode]);
}
...
class Tuple7<T1, T2, T3, T4, T5, T6, T7> {
  ...
  factory Tuple7.fromList(List items) {
    ...
    return Tuple7<T1, T2, T3, T4, T5, T6, T7>(
        items[0] as T1, items[1] as T2, items[2] as T3, items[3] as T4, items[4] as T5, items[5] as T6, items[6] as T7);
  }
  ...
  int get hashCode => Object.hashAll(
      [item1.hashCode, item2.hashCode, item3.hashCode, item4.hashCode, item5.hashCode, item6.hashCode, item7.hashCode]);
}
