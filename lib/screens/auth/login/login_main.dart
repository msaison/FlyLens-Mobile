                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Text(
                            ...
                            maxLines: 3,
                            style:
                                TextStyle(color: AppColor.primaryColor, fontSize: 23.sp, fontWeight: FontWeight.w600),
                          ),
                        ),
                        SizedBox(height: 30.h),
                        ...
                        TextFormUpdated.classic(
                          ...
                          suffixChild: Ink(
                            ...
                            icon: Icon(!passwordObscuring ? CupertinoIcons.eye_fill : CupertinoIcons.eye_slash_fill),
                            color: passwordObscuring ? AppColor.primaryColor.withOpacity(0.35) : AppColor.primaryColor,
                          )),
                        ),
                        SizedBox(height: 17.h),
                        TextButtonUpdated(
